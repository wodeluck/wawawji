...
(function(webim) {
	...
	webim.setConfig = function(config){
		ctx.sdkAppID = config.sdkAppID;
		ctx.appIDAt3rd = config.appIDAt3rd;		
		ctx.identifier = config.identifier;
		ctx.userSig = config.userSig;
		ctx.accountType = config.accountType;
	}
})(webim);