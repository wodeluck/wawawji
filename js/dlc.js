...
function dlcUrl(){
    return 'http://wawa.app.xiaozhuschool.com/';
}
...
var dlctipbox = {
    ...
    confirm:function(msg,cb){
        if(!document.getElementById('mask')){showMask(1);}
        var html = '<div id="confirm" class="bw border-r1 pos_f dpn" style="z-index:9527;top: 3.4rem;width: 6.3rem;left: 50%;margin-left: -3.15rem;overflow: hidden;">'+
            '<p class="font17 ptb60 flex_aj plr40 tac" style="min-height: 2.3rem;">'+msg+'</p>'+
            '<div class="font16 lh100 flex_a tac bdt">'+
            '<a class="flex1 bc colw" onclick="dlctipbox.confirm_callback(0)">取消</a>'+
    ...
    loading:function(msg){
        var msg=msg?msg:'请稍后...';
        var str='<div style="background: rgba(0,0,0,0.6);width: 2rem;z-index:999999;height: 2rem;position: fixed;left: 50%;top: 50%;margin-left: -1rem;margin-top: -1rem;" class="flex flex-column flex-all-center" id="dlctipbox_loading">'+
